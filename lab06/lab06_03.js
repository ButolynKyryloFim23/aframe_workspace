let marker_visible = { A: false, B: false, C: false};
...
AFRAME.registerComponent("run", {
    init: function () {
        ...
        this.CA = document.querySelector("#CA").object3D;
        ...
        this.lineCA = new THREE.Mesh(geometry, material);

        this.lineAB.visible = false;
        this.lineBC.visible = false;
        this.lineCA.visible = false;
        ...
        this.CA.add(this.lineCA);
        console.log(this.CA);

    },
    tick: function (time, deltaTime) {
        if (marker_visible["A"] && marker_visible["B"] && marker_visible["C"]) {
            this.lineAB.visible = true;
            this.lineBC.visible = true;
            this.lineCA.visible = true;
            ...
            const vidstanCA = vecC.distanceTo(vecA);
            ...
            this.lineCA.lookAt(vecA);
            this.lineCA.scale.set(1, 1, vidstanCA);

            console.log("AB = ", vidstanAB);
            console.log("BC = ", vidstanBC);
            console.log("CA = ", vidstanCA);
