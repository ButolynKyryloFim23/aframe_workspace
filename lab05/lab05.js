const earthday = 24.0 * 60 * 60;    // hours to minutes and finally to seconds
...
AFRAME.registerComponent('planet',
    {
        ...
        init: function ()
        {
            this.data.T = this.data.T * earthday;
...
AFRAME.registerComponent('main', {
    ...
    tick: function (time, deltaTime) {
        const dt = earthday/3; //крок інтегрування
        ...
        for(var i = 0; i<this.solar_system.length; i++) {
            ...
            this.solar_system[i].setAttribute('position',(planet_i.pos[0]/1e9)+' '+(planet_i.pos[1]/1e9)+
                ' '+(planet_i.pos[2]/1e9));
        }
    }
});